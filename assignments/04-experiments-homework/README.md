...
Everything that touches the **mathematics, the logic, and the structure of the solution** I am counting on you to do yourself. Setting up the MDE formula, choosing the harmful direction per metric, reading the readout table, writing the interpretation — those are the parts where the assignment is supposed to teach you something. If an AI hands you those, you have not learned them.
...
| 3 | Analysis: readout table over all 6 metrics + success test on ARPU at $\alpha=0.05$ + deterioration scan at $\alpha/6$ + 2–3 sentence interpretation. | 3 |
